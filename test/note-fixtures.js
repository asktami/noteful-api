function makeNoteArray() {
	return [
		...
		},
		{
			...
			folderId: 1,
			content:
				'Tempore aliquam nobis amet dolor laborum aspernatur aspernatur. Non porro est mollitia nobis.'
		},
		{
			id: 13,
			name: 'Turtles',
			...
			folderId: 2,
			content:
				'Fugiat dolores et nostrum laborum id delectus sint reiciendis. Recusandae nulla repellenduss'
		},
		{
			id: 14,
			name: 'Zebras',
			...
			folderId: 2,
			content: 'Veritatis porro minima perspiciatis.'
		}
	];
}
